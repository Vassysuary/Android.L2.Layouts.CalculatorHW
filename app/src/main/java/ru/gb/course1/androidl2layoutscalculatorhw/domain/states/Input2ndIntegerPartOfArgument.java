...
public class Input2ndIntegerPartOfArgument extends BaseState {

    public Input2ndIntegerPartOfArgument(List<InputSymbol> input, List<InputSymbol> input1, float arg, char op) {
